...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-10 14:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/92473431-d585-4569-825c-f65720d314a0.git
$ cd 92473431-d585-4569-825c-f65720d314a0
```
